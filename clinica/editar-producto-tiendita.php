...
<div class="container-fluid py-4 mt-5">
    <div class="card-body px-0 pt-0 pb-4 pt-3 mt-5">
        <a href="tiendita.php" class="text-secondary mt-3"><i class="fa fa-undo" aria-hidden="true"></i>
             Volver a todos la tiendita</a>  
    ...
    <form action="updates/producto-tiendita.php?id_producto=<?php echo $producto['id_producto']; ?>" method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-6">
