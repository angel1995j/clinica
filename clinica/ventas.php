...
<div class="container-fluid">
    ...
    <div class="row container mt-5">
        <div class="mb-5 mb-sm-0 mt-3 text-center">
            <h1 class="card-title fw-semibold">Desglose del mes actual</h1>
        </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    <a href="pagos.php" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Ver todos los pagos">
                                        Ver todos los pagos
                                    </a>
                                </td>
                            </tr>
                    ...
                    <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    <a href="compras.php" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Ver todas las compras">
                            ...
                            <tr>
                                ...
                                <td class="text-sm">
                                    <span class="text-xs font-weight-bold">
                                        ...
                                        echo number_format($ganancias, 2); ?>
                                    </span>
                                </td>
                                <td class="align-middle text-center">
        ...
        <div class="card mb-4 px-3">
            <div class="card-body px-0 pt-0 pb-2">
                <h3 class="mt-3 mb-3">Mostrar ventas especificas</h3>
                <div class="table-responsive p-0">
                    <!-- Formulario para enviar datos a venta-individual.php -->
                    <form action="ventas-individual.php" method="POST">
                        <div class="row">
        ...
        // Consulta SQL para obtener las órdenes del mes actual
        $sqlOrdenesMes = "SELECT * FROM ordenes
                          WHERE fecha_creacion BETWEEN '$primerDiaMes' AND '$ultimoDiaMes'";

        $resultOrdenesMes = $link->query($sqlOrdenesMes);

        if ($resultOrdenesMes && $resultOrdenesMes->num_rows > 0) {
            $totalRegistrosOrdenes = $resultOrdenesMes->num_rows;
            $totalOrdenes = 0;
            while ($rowOrdenesMes = $resultOrdenesMes->fetch_assoc()) {
                $totalOrdenes += $rowOrdenesMes['total'];
            }
        } else {
            // Si no hay datos, establecer valores predeterminados
            $totalRegistrosOrdenes = 0;
            $totalOrdenes = 0;
        }
        ?>
