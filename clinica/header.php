      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <?php if (!$hideAdminMenu) { ?> 
            <li class="nav-small-cap">
              <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
              <span class="hide-menu">Administración</span>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="tiendita.php" aria-expanded="false">
                <span>
                  <i class="ti ti-book-off"></i>
                </span>
                <span class="hide-menu">Tiendita</span>
              </a>
            </li>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="solicitudes.php" aria-expanded="false">
                <span>
                  <i class="ti ti-book-off"></i>
                </span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="empleados.php" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="compras.php" aria-expanded="false">
                <span>
                  <i class="ti ti-analyze"></i>
                </span>
                <span class="hide-menu">Seguimiento a compras</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="ventas.php" aria-expanded="false">
                ...
                <span class="hide-menu">Reportes de ventas</span>
              </a>
            </li>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="crm.php" aria-expanded="false">
                <span>
                  <i class="ti ti-mood-happy"></i>
                </span>
                <span class="hide-menu">CRM Propectos</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="vendedores.php" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="sin-conexion.php" aria-expanded="false">
                <span>
                  <i class="ti ti-aperture"></i>
                </span>
                <span class="hide-menu">Sin conexión</span>
              </a>
            </li>
