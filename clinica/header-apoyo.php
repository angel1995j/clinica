        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="index_apoyo.php" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="agenda-apoyo.php" aria-expanded="false">
                <span>
                  <i class="ti ti-calendar"></i>
                </span>
                <span class="hide-menu">Mi Agenda</span>
              </a>
            </li>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="pacientes-apoyo.php" aria-expanded="false">
                <span>
