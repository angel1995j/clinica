...
/* Filtrado */
$where = 'WHERE tipo_producto = "medicina" AND estatus = 0';
...
if ($num_rows > 0) {
    while ($row = $resultado->fetch_assoc()) {
        ...
        $output['data'] .= '<a href="updates/activar-producto-medicina.php?id_producto=' . $row['id_producto'] . '" class="btn btn-outline-danger m-1">Activar</a></div>';
