...
$columns = ['p.id_pago', 'p.monto', 'p.fecha_agregado', 'p.estatus', 'pac.nombre', 'pac.aPaterno', 'pac.aMaterno'];
...
if ($num_rows > 0) {
    while ($row = $resultado->fetch_assoc()) {
        ...
        $output['data'] .= '<td class="align-middle text-center text-sm"><span class="text-secondary text-xs font-weight-bold"><a class="btn boton-secundario" href="updates/activar-pago.php?id_pago=' . $row['id_pago'] . '">Reactivar pago</a></span></td>';
