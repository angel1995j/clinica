...
if ($num_rows > 0) {
    while ($row = $resultado->fetch_assoc()) {
        ...
        $output['data'] .= '<td class="align-middle text-center text-sm"><span class="text-secondary text-xs font-weight-bold"><a class="btn boton-secundario" href="cambiar-clave.php?id_usuario=' . $row['id_usuario'] . '">Cambiar clave</a></span></td>'; 

        $output['data'] .= '<td class="align-middle text-center text-sm"><span class="text-secondary text-xs font-weight-bold"><a class="btn boton-secundario" href="updates/archivar-usuarios.php?id_usuario=' . $row['id_usuario'] . '">Archivar usuario</a></span></td>';
