          ...
          <div class="card mb-4 px-3 mt-5">
            ...
            <div class="container">
              ...
              <div class="row">
                ...
                <h1 class="mb-4 mt-3">Donacion de ingreso del paciente: <?php echo $paciente['nombre']. " " . $paciente['aPaterno'];?></h1>
                <form action="inserts/pago-inicial-vendedor.php?id_paciente=<?php echo $id_paciente; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="text" class="form-control" name="observaciones" id="observaciones" value="donación de ingreso">
