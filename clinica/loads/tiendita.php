...
/* Filtrado */
$where = 'WHERE tipo_producto = "tiendita" AND estatus ="1"';
...
if ($num_rows > 0) {
    while ($row = $resultado->fetch_assoc()) {
        ...
        $output['data'] .= '<a href="updates/archivar-producto.php?id_producto=' . $row['id_producto'] . '" class="btn btn-outline-danger m-1">Archivar</a></div>';
