...
/* Filtrado */
$where = "archivado = 'no' and estatus = 'No Pagada'";
...
if ($num_rows > 0) {
    while ($row = $resultado->fetch_assoc()) {
        ...
        $output['data'] .= '<td class="align-middle text-center text-sm"><span class="text-secondary text-xs font-weight-bold"><a class="btn btn-primary" href="reportar-compra.php?id_compra=' . $row['id_compra'] . '">Reportar compra</a></span></td>';

        $output['data'] .= '<td class="align-middle text-center text-sm"><span class="text-secondary text-xs font-weight-bold"><a class="btn boton-secundario" href="updates/archivar-compras.php?id_compra=' . $row['id_compra'] . '">Archivar</a></span></td>';
