<?php require "header.php";?> 
    ...
    <div class="container-fluid py-4 mt-5">
      <div class="row mt-5">
        ...
        <div class="col-8 mb-4 mt-3" style="text-align:right;">
          <!--<a href="carrito.php" class="btn btn-primary">Nuevo consumo</a>-->
          <a href="consumo-cocina.php" class="btn btn-primary">Nuevo consumo</a>
          <button type="button" class="btn boton-secundario" data-bs-toggle="modal" data-bs-target="#nuevoProducto">
            Añadir nuevo producto
          </button>
           <a href="consumos-cocina.php" class="btn boton-secundario">Ver consumos</a>
            <a href="cocina-inactivos.php" class="btn boton-secundario">Ver productos inactivos</a> 
        </div>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Sección de Cocina</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                  Aqui podemos gestionar todos los productos referentes a le cocina, se puede añadir o retirar el stock, archivar productos asi como añadir nuevos productos, de la misma manera se pueden revisar todos los consumos que se han tenido.
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form action="inserts/cocina.php" method="post" enctype="multipart/form-data">
