...
<div class="container-fluid py-4 mt-5">
    <div class="card-body px-0 pt-0 pb-4 pt-3 mt-5">
        ...
        <div class="container">
            <h2 class="mt-5 text-center">Confirmar generar adeudo</h2>
            <p class="text-center">Se generará deuda al paciente</p>
            <form action="updates/adeudo-tiendita.php" method="post" class="mt-4">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="total_no_pagado">Total a deuda</label>
