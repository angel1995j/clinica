...
/* Filtrado */
$where = ($id_paciente !== null) ? "id_paciente = '$id_paciente' AND archivado = 'no'" : 'archivado = "no"';
...
if ($num_rows > 0) {
    while ($row = $resultado->fetch_assoc()) {
        ...
        $output['data'] .= '<td class="text-center"><a class="btn boton-secundario" href="updates/archivar-saldo.php?id_historial=' . $row['id_historial'] . '&id_paciente=' . $id_paciente . '">Archivar saldo</a></td>';
        $output['data'] .= '</tr>';
    }
} else {
    $output['data'] .= '<tr>';
