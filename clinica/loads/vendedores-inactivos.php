...
/* Filtrado */
$where = "archivado = 'si' and rol = 'Vendedor'";
...
if ($num_rows > 0) {
    while ($row = $resultado->fetch_assoc()) {
        ...
        $output['data'] .= '<td class="align-middle text-center text-sm"><span class="text-secondary text-xs font-weight-bold"><a class="btn boton-secundario" href="updates/activar-vendedores.php?id_usuario=' . $row['id_usuario'] . '">Reactivar</a></span></td>';
