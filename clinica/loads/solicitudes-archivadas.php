...
if ($num_rows > 0) {
    while ($row = $resultado->fetch_assoc()) {
        ...
        $output['data'] .= '<td class="align-middle text-center text-sm"><span class="text-secondary text-xs font-weight-bold"><a class="btn boton-secundario" href="updates/activar-solicitud.php?id_solicitud=' . $row['id_solicitud'] . '"">Activar</a></span></td>';
