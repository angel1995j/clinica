            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Sección de vendedores</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                  Desde aqui podemos visualizar los vendedores, archivarlos, ver historial de sus ventas asi como gestionar sus comisiones, ya sea que se quiera añadir una comsión o pagar alguna ya agregada.
