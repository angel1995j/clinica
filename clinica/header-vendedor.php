        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="index_vendedor.php" aria-expanded="false">
                <span>
            ...
            <li class="nav-small-cap">
             ...
             <li class="sidebar-item">
              <a class="sidebar-link" href="crm-vendedor.php" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="historial-vendedor.php" aria-expanded="false">
                <span>
                  <i class="ti ti-mood-happy"></i>
                </span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="nuevo-paciente-vendedor.php" aria-expanded="false">
                <span>
                  <i class="ti ti-mood-happy"></i>
                </span>
                <span class="hide-menu">Nuevo Paciente</span>
              </a>
            </li>
