    ...
    <div class="container-fluid py-4 mt-5">
      <div class="row mt-5">
        ...
        <div class="col-12">
          ...
          <form action="inserts/pacientes-vendedor.php" method="POST">
          <div class="row mt-3">
            ...
            <div class="row mt-3">
                ...
                <input type="text" class="form-control" placeholder="Nombre completo" name="aPaterno">
                </div>

                <div class="form-group col-md-6 col-sm-12 mt-3">
                  <label>Apellido Materno</label>
                <input type="text" class="form-control" placeholder="Nombre completo" name="aMaterno">
                </div>
            ...
            <label>¿Lo refiere alguna institución?</label>
                <div>
                    <label class="radio-inline">
                        <input type="radio" name="institucionRefiere" value="Si" name="referido"> Si
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="institucionRefiere" value="No" name="referido"> No
                    </label>
                </div>
            ...
            <div class="form-group col-md-6 col-sm-12 mt-3">
                ...
                <div>
                    <label class="radio-inline">
                        <input type="radio" name="hojaReferencia" value="Si" name="hojaReferencia"> Si
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="hojaReferencia" value="No" name="hojaReferencia"> No
                    </label>
                </div>
            ...
            <div class="form-group col-md-6 col-sm-12 mt-3">
                ...
                <div>
                    <label class="radio-inline">
                        <input type="radio" name="tipoIngreso" value="Voluntario" name="tipoIngreso"> Voluntario
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="tipoIngreso" value="Involuntario" name="tipoIngreso"> Involuntario
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="tipoIngreso" value="Obligatorio" name="tipoIngreso"> Obligatorio
                    </label>
                </div>
            </div>
            ...
            <div class="form-group col-md-6 col-sm-12 mt-3">
                ...
                <input type="text" class="form-control" placeholder="parentescoFamiliar">
            </div>
            <div class="form-group col-md-6 col-sm-12 mt-3">
                <label>Dirección:</label>
            ...
            <div class="form-group col-md-6 col-sm-12 mt-3">
                ...
                <div>
                    <label class="radio-inline">
                        <input type="radio" name="llegaIntoxicado" value="Si" name="intoxicado"> Si
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="llegaIntoxicado" value="No" name="intoxicado"> No
                    </label>
                </div>
            </div>
            </div> <!-- END ROW -->
