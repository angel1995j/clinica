...
$sql = "INSERT INTO consumo (concepto, monto, fecha_consumo, id_usuario, id_paciente) VALUES (?, ?, ?, ?, ?)";
...
if ($stmt) {
    ...
    $stmt->bind_param("sdsii", $concepto, $totprecio, $fecha_consumo, $id_usuario, $id_paciente);
