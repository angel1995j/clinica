    ...
    <div class="container-fluid py-4 mt-5">
      <div class="row mt-5">
        ...
        <div class="col-6 mb-4">
          <!--<a href="vendedores-archivados.php" class="btn boton-secundario" style="margin-left: 2%;">Ver archivados</a>-->
        </div>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Sección de sector salud activos</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                  Desde aqui podemos visualizar los empleados del sector salud activos..
        ...
        <div class="col-12 mt-5">
          <div class="card mb-4 px-3">
            <div class="card-header pb-0">
              <h6>Todos los empleados de salud</h6>
            </div>
