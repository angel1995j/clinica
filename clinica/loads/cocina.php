...
/* Filtrado */
$where = 'WHERE tipo_producto = "cocina" AND estatus = 1';
...
if ($num_rows > 0) {
    while ($row = $resultado->fetch_assoc()) {
        ...
        $output['data'] .= ' <div class="d-flex"> <a href="editar-producto-cocina.php?id_producto=' . $row['id_producto'] . '" class="btn btn-outline-secondary m-1">Editar</a>';
        $output['data'] .= '<a href="updates/archivar-producto-cocina.php?id_producto=' . $row['id_producto'] . '" class="btn btn-outline-danger m-1">Archivar</a></div>';
