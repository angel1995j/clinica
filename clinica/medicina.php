    ...
    <div class="container-fluid py-4 mt-5">
      <div class="row mt-5">
        ...
        <div class="col-8 mb-4 mt-3" style="text-align:right;">
          ...
          <a href="consumo-medicina.php" class="btn btn-primary">Nuevo consumo</a>
          <button type="button" class="btn boton-secundario" data-bs-toggle="modal" data-bs-target="#nuevoProducto">
            Añadir nuevo producto
          </button>
           <a href="consumos-medicina.php" class="btn boton-secundario">Ver consumos</a>
            <a href="medicina-inactivos.php" class="btn boton-secundario">Ver productos inactivos</a> 
        </div>
